...
obj = osf_risk_model.OsfRiskTrainingClass.model_nn_floodability_loanbook_assets(source_json_file)
#
print ("<< --- Model Training with Pytorch nn(neural network) - accuraccy of results displayed --- >>")
#
